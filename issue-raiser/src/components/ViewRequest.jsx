...
const ViewRequest = () => {
  // Here instead of this dummy object,
  // we will receive the request id, and make a call to backend
  //to fetch the patient and complaint details
  const patientDetails = {
    firstName: "Indira",
    lastName: "Kumar",
    phoneNumber: "8300228399",
    inPatientNumber: "098765",
    email: "indirakumarak123@gmail.com",
    priority: "High",
    complaint: "fan not working",
  };
  return (
    <div className="grid p-8">
      <form className="w-100 rounded-lg">
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          ...
          <div className="relative z-0 mb-6 w-full group">
            <input
              ...
              required
              disabled
              value={patientDetails.inPatientNumber}
            />
            <label
